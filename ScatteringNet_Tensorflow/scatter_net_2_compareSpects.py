...
if __name__=="__main__":
    ...
    parser.add_argument("--data",type=str,default='/Users/johnpeurifoy/Documents/skewl/PhotoNet/ScatteringNet/ScatteringNet_Matlab/data/CompleteDataFiles/8_layer_tio2_combined')
    parser.add_argument("--output_folder",type=str,default='results/8_Layer_TiO2_Final_3/')
