...
csvwrite(strcat('data/',num2str(num_layers),'_layer_tio2_fixed_06_21_4.csv'),myspects);
csvwrite(strcat('data/',num2str(num_layers),'_layer_tio2_fixed_06_21_4_val.csv'),values);