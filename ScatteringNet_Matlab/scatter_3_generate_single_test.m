...
myname = num2str(strcat('spectrums/test_tio2_fixed_8/',num2str(r1),'_',num2str(r2),'_',num2str(r3),'_',num2str(r4),'_',num2str(r5),'_',num2str(r6),'_',num2str(r7),'_',num2str(r8)));
