...
for v1=[30,70.0];
    for v2=[30,70.0];
        for v3=[30,70.0];
            for v4=[30,70.0];
                spect = scatter_0_generate_spectrum([v1,v2,v3,v4,v4,v3,v2,v1]);
                %spect(1:1:501,1)./(3*lambda.*lambda)*2*pi
                myspects = [myspects spect(1:1:401,1)];%./(3*lambda.*lambda)*2*pi];
                myname = num2str(strcat(num2str(v1),'--',num2str(v2),'--',num2str(v3),'--',num2str(v4),'--',num2str(v4),'--',num2str(v3),'--',num2str(v2),'--',num2str(v1)));
