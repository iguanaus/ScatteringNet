...
input_ex = [60;60;50;30;70;40;60;60]
input_ex_2 = [50;50;40;40;60;50;50;50]
...
result = result(1:2:399,1);

result_ex = scatter_0_generate_spectrum(input_ex);
result_ex = result_ex(1:2:399,1);

result_ex2 = scatter_0_generate_spectrum(input_ex_2);
result_ex2 = result_ex2(1:2:399,1);
...
hold on
plot(lambda(1:2:399,1),result,lambda(1:2:399,1),result2,'-.')
...
legend('Simulation','NN Approx','Closest Train','Closest Train');
xlabel('Wavelength (nm)');
ylabel('\sigma/\pi r^2');
title('Comparing NN approximation to Simulation');
set(gca,'fontsize',16)
