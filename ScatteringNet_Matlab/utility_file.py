...
def combineFile():
	file1 = open('data/5_layer_tio2_fixed_2_val.csv','r')
	file2 = open('data/5_layer_tio2_fixed_val.csv','r')
	out = open('data/5_layer_tio2_combined_val.csv','w')
...
def combineFileHorizontally():
	#f = open('order_die_1.csv','r')
	out = open('data/5_layer_tio2_combined.csv','w')

	train_Y_1 = np.genfromtxt('data/5_layer_tio2_fixed_2.csv',delimiter=',')
	train_Y_2 = np.genfromtxt('data/5_layer_tio2_fixed.csv',delimiter=',')
